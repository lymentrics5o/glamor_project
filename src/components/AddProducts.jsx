...
const AddProduct = () => {
    ...
    try {
        ...
        const response= await axios.post("https://luke6.pythonanywhere.com/api/addproducts",data)
        setLoading("");
    ...
    return (
        ...
        <div className="row justify-content-center">
            <nav className="m-4">
            <Link className="btn btn-dark mx-2" to="/home">add product</Link>
            ...
            <div className="col-md-6">
                ...
                onChange={(e)=>setProductPhoto(e.target.files[0])} />
                 ...
                 <button className="btn btn-warning form-control">Add your jewellery</button>
                </form>
